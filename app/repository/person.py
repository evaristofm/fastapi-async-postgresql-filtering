...
from sqlalchemy import column, delete, func, or_, select, text, update

from app.config import commit_rollback, db
from app.models import Person
from app.schemas import PersonCreate, PageResponse
...
class PersonRepository:
    ...
    @staticmethod
    async def update(person_id: int, form_person: PersonCreate):
        """Update person data"""
        query = update(Person)\
