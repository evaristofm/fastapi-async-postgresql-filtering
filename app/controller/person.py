...
async def create_person(person: PersonCreate):
    ...
    return ResponseSchema(detail="Successfully created person!")
...
async def update_person(person_id: int = Path(..., alias="id"), *, update_form: PersonCreate):
    ...
    return ResponseSchema(detail="Successfully updated person!")
...
async def delete_person(person_id: int = Path(..., alias="id")):
    ...
    return ResponseSchema(detail="Successfully deleted person!")
